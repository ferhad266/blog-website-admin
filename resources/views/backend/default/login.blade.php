...
<head>
    ...
    <style>
        .login-page {
            background: url("/images/settings/codeeee.jpeg") no-repeat center fixed;
...
<div class="login-box">
    <div class="login-logo">
        <a style="color: black; " href="{{route('nedminLogin')}}"><b>FM</b>ADMIN</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        ...
        <form action="{{route('nedminAuth')}}" method="post">
            @csrf
